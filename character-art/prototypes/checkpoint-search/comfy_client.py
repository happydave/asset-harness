#!/usr/bin/env python3
"""Shared ComfyUI client helpers. Copied verbatim from music-video/prototypes/ (which invites it:
"copyable by other tracks"), so the character-art harness inherits its terminal-state waiting
