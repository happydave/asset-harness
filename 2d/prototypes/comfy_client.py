#!/usr/bin/env python3
"""Shared ComfyUI client helpers for the 2d prototypes.

A verbatim copy of `music-video/prototypes/comfy_client.py`, whose docstring sanctions exactly this
("copyable by other tracks"): tracks stay independent of one another, so shared helpers are copied
rather than imported across track boundaries. Keep the two in step when either changes.
