"""Run the TRELLIS.2 geometry path WITH the template's stock mesh postprocess tail.
...
G = {
  ...
  "241": {"class_type": "RemeshMesh", "inputs": {"mesh": ["202", 0], "resolution": 768, "sign_mode": "udf",
          "sign_mode.qef": False, "sign_mode.drop_enclosed_components": False,
  ...
  "186": {"class_type": "DecimateMesh", "inputs": {"mesh": ["241", 0], "target_face_count": 700000,
          "placement_mode": "midpoint"}},
  "238": {"class_type": "MeshSmoothNormals", "inputs": {"mesh": ["186", 0], "crease_angle": 180.0}},
  "285": {"class_type": "MeshToFile3D", "inputs": {"mesh": ["238", 0]}},
